...
describe ExchangesController do
  describe 'GET index' do
    ...
    it 'sets @currencies' do
      ...
      usd_currency = Fabricate(:currency,
                               code: Money::Currency.new('USD').iso_code)
      sign_in(user)
      get :index
  ...
  describe 'POST create' do
    ...
    it 'creates the exchange' do
      ...
      usd_currency = Fabricate(:currency,
                               code: Money::Currency.new('USD').iso_code)
      sign_in(user)
      post :create, params: { exchange: { base_currency_id: eur_currency.id,
                                          target_currency_id: usd_currency.id,
                                          amount: 100, period: 1 } }
  ...
  describe 'DELETE destroy' do
    ...
    it 'deletes the record' do
      ...
      usd_currency = Fabricate(:currency,
                               code: Money::Currency.new('USD').iso_code)
      exchange = Exchange.create(amount: 100, period: 1,
